...
></div>
 ...
 <div class="flex flex-wrap items-center gap-4 text-sm justify-center md:justify-end w-full md:w-auto">
  ...
  <!-- Login / Register can stay as normal links if outside router -->
  <router-link
    v-if="token1"
    to="/login"
  ...
  <router-link
    to="/shop"
    class="group relative flex items-center justify-center transition text-xl text-gray-600 hover:text-orange-600"
  ...
  <router-link
    to="/my-carts"
    class="group relative flex items-center justify-center transition text-2xl text-gray-600 hover:text-orange-600"
    active-class="text-orange-600"
    exact
  >
  ...
  >
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-6 h-6">
      <path fill-rule="evenodd" d="M4.25 2A2.25 2.25 0 0 0 2 4.25v11.5A2.25 2.25 0 0 0 4.25 18h11.5A2.25 2.25 0 0 0 18 15.75V4.25A2.25 2.25 0 0 0 15.75 2H4.25ZM3.5 8v7.75c0 .414.336.75.75.75h11.5a.75.75 0 0 0 .75-.75V8h-13Z" clip-rule="evenodd" />
    </svg>
