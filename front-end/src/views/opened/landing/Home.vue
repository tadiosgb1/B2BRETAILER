  ...
  <div class="flex flex-col h-screen">
    ...
    <main class="flex-1 overflow-y-auto">
      <div class="min-h-full bg-gray-50">
        ...
        <!-- Categories Section -->
        <div class="relative px-6 py-6 m-0 lg:mx-10 lg:my-10">
        ...
        <!-- Product Sections -->
        <div v-for="section in sections" :key="section.id" class="p-4 m-0 lg:mx-10 lg:my-10">
...
main::-webkit-scrollbar-thumb { background-color: rgba(0,0,0,0.3); border-radius:2px; }
main { scrollbar-width: thin; scrollbar-color: rgba(0,0,0,0.3) transparent; }
</style>
